...
Here we create two constructors whom both go to the same type, \texttt{String | Float}.
...
We then want to define the module \verb\Add\ with the \verb\+\ operator and the \texttt{identityAdd} constant.
...
This creates a constant named \verb\caretTest\ with the same value as \texttt{identityAdd} from the module \verb\IntAdd\.
...
With this construct we have created the partially applied function \texttt{addThree}.
