...
The \verb\RecordEntry\ is created in the premise and then passed to \texttt{UpdatableRecord}.
...
If there are no collisions and there are more points in the trail, \texttt{checkTrails} is recursively called.
...
The position of the current bike and the trail of the first bike in the record, will be passed to \texttt{checkTrails}.
