\chapter{Typeproofs}\label{app:typeproofs}
This contains the type proof of the \verb\try\ function of the \verb\TryableMonad\, as described in section~\ref{sec:standardtryablemonad}.
