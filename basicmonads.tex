...
As we can see the variable \verb\a\ is directly passed on.
...
With these functions implemented the monad can be used with a wider range.
...
The variable \verb\'M\ is the monad given to the monad transformer.
...
\textbf{DO THIS !!!!!!!!!!!!!!!!!!!}
started with MCons, bind, return and returnFrom.
added lift, lift2 and liftM
...
\textbf{DO THIS!!!!!!!!!}
Was first implemented without tyable monad
