...
Monads enable purity of code with the power of mutables.
The structure of monads also enables a customizable flow of control.
...
If monad transformers always take another monad, there has to be atleast one monad to end the chain.
